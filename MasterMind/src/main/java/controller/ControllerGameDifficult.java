 ...
 * @author silvia
 */
public class ControllerGameDifficult implements ActionListener {
    //view y model
    ViewGameDifficult view;
    ModelGameDifficult model;

    public ControllerGameDifficult(ViewGameDifficult view, ModelGameDifficult model) {
        this.view = view;
        this.model = model;
        model.getLength();
    ...
    private void finishGame(boolean won) {
        ...
        if (choice == JOptionPane.YES_OPTION) {
           ...
           // ViewIndex view = new ViewIndex();
            //ControllerIndex c = new ControllerIndex(view, new GameModel(),this.model);
        }
    }
